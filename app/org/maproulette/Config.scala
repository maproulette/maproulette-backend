...
object Config {
  ...
  val KEY_SCHEDULER_START_TIME_JITTER_MINUTE_TASKS =
    s"$SUB_GROUP_SCHEDULER.startTimeJitterForMinuteTasks"
  val KEY_SCHEDULER_START_TIME_JITTER_HOUR_TASKS =
    s"$SUB_GROUP_SCHEDULER.startTimeJitterForHourTasks"
