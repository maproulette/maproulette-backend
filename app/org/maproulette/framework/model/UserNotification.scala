...
object UserNotification extends CommonField {
  ...
  val NOTIFICATION_TYPE_META_APPROVED                   = 16
  val NOTIFICATION_TYPE_META_APPROVED_NAME              = "Meta-Approved"
  val NOTIFICATION_TYPE_META_REJECTED                   = 17
  val NOTIFICATION_TYPE_META_REJECTED_NAME              = "Review Again"
  ...
  val notificationTypeMap = Map(
    ...
    NOTIFICATION_TYPE_META_APPROVED              -> NOTIFICATION_TYPE_META_APPROVED_NAME,
    NOTIFICATION_TYPE_META_REJECTED              -> NOTIFICATION_TYPE_META_REJECTED_NAME,
